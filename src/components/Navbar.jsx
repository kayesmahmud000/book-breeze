...
const Navbar = () => {
    ...
    const link = <>
        <li><NavLink className={({ isActive }) => isActive ? "text-white underline mb-3 px-3 py-2  text-sm lg:text-lg" : " mb-4 px-3 text-sm lg:text-lg"} to={"/"}>Home</NavLink></li>
        <li><NavLink className={({ isActive }) => isActive ? "text-white underline mb-3 px-3 py-2  text-sm lg:text-lg" : " mb-4 px-3 text-sm lg:text-lg"} to={"/allBook"}>All Books</NavLink></li>
        
        {
            user?.email && <> <li><NavLink className={({ isActive }) => isActive ? "text-white underline mb-3 px-3 py-2  text-sm lg:text-lg" : " mb-4 px-3 text-sm lg:text-lg"} to={"/addBook"}>Add Book</NavLink></li>
                <li><NavLink className={({ isActive }) => isActive ? "text-white underline mb-3 px-3 py-2  text-sm lg:text-lg" : " mb-4 px-3 text-sm lg:text-lg"} to={"/borrowedBooks"}>Borrowed Books</NavLink></li>
            </>
        }
        <li><NavLink className={({ isActive }) => isActive ? "text-white underline mb-3 px-3 py-2  text-sm lg:text-lg" : " mb-4 px-3 text-sm lg:text-lg"} to={"/about"}>About Us</NavLink></li>
        
        <li><NavLink className={({ isActive }) => isActive ? "text-white underline mb-3 px-3 py-2  text-sm lg:text-lg" : " mb-4 px-3 text-sm lg:text-lg"} to={"/contact"}>Contact Us</NavLink></li>
    </>
    return (
        <div>
            <div className="navbar container mx-auto text-black ">
                ...
                <div className="navbar-end">
                    <label className="swap md:mr-5 swap-rotate">
                        ...
                        {/* sun icon */}
                        <svg
                            className="swap-off h-7 w-7 mt-1 fill-current"
                        ...
                        {/* moon icon */}
                        <svg
                            className="swap-on h-7 w-7  mt-1  fill-current"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24">
                            <path
